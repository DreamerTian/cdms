<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/seller/view/index\index.html";i:1551086605;s:63:"E:\data\git_depot\cdms\application\seller\view\public\left.html";i:1551064078;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:''); ?></title>
...
<div class="admincp-header">
	...
	<div class="nc-module-menu">
		<ul class="nc-row">
            ...
            <li data-param="decorate"><a href="javascript:void(0);">内容</a></li>
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <!--<div class="about" title="关于系统" onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'<?php echo U("Index/about"); ?>', });"><i class="fa fa-copyright"></i><span></span></div>-->
</div>
