<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./application/seller/view/seller\login.html";i:1551084759;}*/ ?>
<!doctype html>
...
<body>
                ...
                <div class="formContent">
                    ...
                    <div class="formInfo">
                        ...
                        <div class="formText">
                            ...
                            <img src="<?php echo U('Seller/vertify'); ?>" class="chicuele" id="imgVerify" alt="" onclick="fleshVerify()">
                        </div>
                        <div class="formText">
                        	<!--<div class="checkbox">
                            	<div class="cur">
                           ...
                           <span class="span">保存信息</span>-->
                            <a href="<?php echo U('Seller/forget_pwd'); ?>" class="forget_pwd">忘记密码？</a>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            function loginsubmit(){
                ...
                if(vertify && $('#theForm input[name=username]').val() != '' && $('#theForm input[name=password]').val() != ''){
                    $.ajax({
                        async:false,
                        url:'/index.php?m=Seller&c=Seller&a=login&t='+Math.random(),
        ...
        function fleshVerify(){
            $('#imgVerify').attr('src','/index.php?m=Seller&c=Seller&a=vertify&r='+Math.floor(Math.random()*100));//重载验证码
        }
